      ...
      <div className={style.module}>
        ...
        <div className={style.modules__items}>
         ...
         <div className={style.dropdown__container}>
           <DropDown title={"Užsakymų registravimo kalendorius"} arrowUnicClass={style.dropdown__arrow}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Ryšių su klientais valdymas"} arrowUnicClass={style.dropdown__arrow}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Personalo administravimas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Finansinės operacijos ir ataskaitos"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Prekių sandėlio valdymas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Dokumentų pildymas ir protokolų kūrimas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Gydymo plano sudarymas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Filialu valdymas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Sąsaja su buhalterine programa „Rivilė“"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"TLK kompensacijų administravimas"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
        ...
        <div className={style.modules__items}>
          ...
          <div className={style.dropdown__container}>
            <DropDown title={"Sąsaja su „E sveikata“"} arrowUnicClass={style.dropdown__arrow}>
              <div className={style.dropdown__item}>lorem ipsum</div>
            </DropDown>
          </div>
          <div className={style.module__item_right}>
